...
public class DriverActivityMapStartFragment extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = (RelativeLayout) inflater.inflate(R.layout.fragment_driver_activity_map_start, container, false);
...
//            }
            ...
            ((MapFragment) this.getChildFragmentManager().findFragmentById(R.id.location_map_start)).getMapAsync(this);
            if (mMap != null)
                onMapReady(mMap);
        }
    }
